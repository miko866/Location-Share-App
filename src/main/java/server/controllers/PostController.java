...
//	@PostMapping("")
//	public ResponseEntity<?>  createNewPost(@RequestParam String title, @RequestParam String street, @RequestParam String streetNumber, @RequestParam String zip, @RequestParam String city, @RequestParam String text, @RequestParam("file") MultipartFile file, BindingResult result, Principal principal) {
//		//* Check custom errors
//		ResponseEntity<?> errorMap = mapValidationErrorService.MapValidationService(result);
//		if (errorMap != null) return errorMap;
//
